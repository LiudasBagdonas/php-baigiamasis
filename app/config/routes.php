...
Router::add('about', '/about', \App\Controllers\Admin\CommentsController::class);

//API Routes
Router::add('post_comment', '/api/comment/post', \App\Controllers\Admin\CommentsController::class, 'create');
Router::add('get_comments', '/api/comment/get', \App\Controllers\Admin\CommentsController::class, 'get');


//// Admin Routes
//Router::add('admin_orders', "/admin/orders", \App\Controllers\Admin\CommentsController::class);
